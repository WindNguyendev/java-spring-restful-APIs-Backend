...
public class PermissionController {
    ...
    public ResponseEntity<Permission> create(@Valid @RequestBody Permission p) throws IdInvaliException {
        ...
        if (this.permissionService.isPermissionExist(p)) {
            throw new IdInvaliException("Permission đã tồn tại.");
        }
    ...
    public ResponseEntity<Permission> update(@Valid @RequestBody Permission p) throws IdInvaliException {
        ...
        if (this.permissionService.fetchById(p.getId()) == null) {
            throw new IdInvaliException("Permission với id = " + p.getId() + " không tồn tại.");
        }
    ...
    public ResponseEntity<Void> delete(@PathVariable("id") long id) throws IdInvaliException {
        ...
        if (this.permissionService.fetchById(id) == null) {
            throw new IdInvaliException("Permission với id = " + id + " không tồn tại.");
        }
